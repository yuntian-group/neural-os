...
which python
stdbuf -oL -eL python main.py --config configs/pssearch_bsz64_acc1_lr8e5_512_leftclick_histpos_512_384_debug.yaml > log.pssearch_bsz64_acc1_lr8e5_512_leftclick_histpos_512_384.cont2.debug.fixed 2>&1
