...
if __name__ == "__main__":
    ...
    if from_autoencoder:
        ...
        model = load_model_from_config(config, '/root/computer/computer/train_dataset_encoded6/sb_diffusion_freezernn_contfiltered_unfreeze_afterchallenging_newdata_pretrainchallenging_addc_allnew_more_c_alldata_diffusion_c_alldata_joint_noss_4Xb/model-step=064000.ckpt')
        #### REPLACEMENT_LINE
