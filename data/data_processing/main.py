...
def parse_args():
    ...
    parser.add_argument("--save_dir", type=str, default='./train_dataset_may20_3_webdataset',
    ...
    parser.add_argument("--actions_dir", type=str, default='/home/yuntian/scratch/raw_data_may20_3/raw_data/actions',
