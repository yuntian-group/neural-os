...
which python
stdbuf -oL -eL python main.py --config configs/pssearch_bsz64_acc1_lr8e5_512_leftclick_histpos.yaml > log.pssearch_bsz64_acc1_lr8e5_512_leftclick_histpos.cont4 2>&1
