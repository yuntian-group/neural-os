...
save_path = 'test_15_500_epoch_seq=8_fine_tuned'
...
if __name__ == "__main__":
    ...
    prompts, image_sequences, targets = get_ground_truths(data, idxs=[i for i in range(173)])
    ...
    sample_model(model, prompts, image_sequences, save_path)