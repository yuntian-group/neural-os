...
if __name__ == "__main__":
    ...
    if from_autoencoder:
        ...
        #model = load_model_from_config(config, '/root/computer/computer/train_dataset_encoded2/saved_final_hs4096_oc32_nl48_ar_cm1_2_mc512_lr8e5_b64_pretrainreal_context32_cont_2Xdata_4Xb/model-step=040000.ckpt')
        #### REPLACEMENT_LINE
