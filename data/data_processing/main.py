...
def parse_args():
    ...
    parser.add_argument("--save_dir", type=str, default='./train_dataset_may20_10_webdataset',
                        help="directory to save the entire training set.")

    parser.add_argument("--video_dir", type=str, default='/home/yuntian/scratch/raw_data_may20_10/raw_data/videos',
                        help="directory where the videos are saved.")
    
    parser.add_argument("--actions_dir", type=str, default='/home/yuntian/scratch/raw_data_may20_10/raw_data/actions',
