...
which python
stdbuf -oL -eL python main.py --config configs/pssearch_bsz64_acc1_lr8e5_512_leftclick_histpos_ss005.yaml > log.pssearch_bsz64_acc1_lr8e5_512_leftclick_histpos_ss005.yaml 2>&1
