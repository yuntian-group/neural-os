...
if __name__ == "__main__":
    ...
    if from_autoencoder:
        ...
        #model = load_model_from_config(config, '/root/computer/computer/train_dataset_encoded/saved_final_hs4096_oc32_nl48_ar_cm1_2_mc512_lr8e5_b64_pretrain2_context8_finetunerealpart1/model-step=024000.ckpt')
        model = load_model_from_config(config, '/root/computer/computer/train_dataset_encoded/saved_final_hs4096_oc32_nl48_ar_cm1_2_mc512_lr8e5_b64_pretrainreal_context32/model-step=088000.ckpt')
