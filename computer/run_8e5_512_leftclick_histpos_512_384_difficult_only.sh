...
which python
stdbuf -oL -eL python main.py --config configs/pssearch_bsz64_acc1_lr8e5_512_leftclick_histpos_512_384_difficult_only.yaml > log.pssearch_bsz64_acc1_lr8e5_512_leftclick_histpos_512_384_difficult_only 2>&1
