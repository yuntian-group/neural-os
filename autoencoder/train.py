...
def train_model(model: VQModel, data: DataModule, save_path: str, config: OmegaConf) -> VQModel:
    ...
    checkpoint_callback = ModelCheckpoint(
        ...
        filename='model_ae_{epoch:02d}',  # Filename format
    ...
    print(f"\u2705 Checkpoints saved at {save_path}")
