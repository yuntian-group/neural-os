...
def parse_args():
    ...
    parser.add_argument("--save_dir", type=str, default='../../computer/train_dataset_encoded3/train_dataset_encoded3_filter',
                        help="directory to save the entire training set.")

    parser.add_argument("--video_dir", type=str, default='../../computer/train_dataset_encoded4/raw_data_apr2/videos',
                        help="directory where the videos are saved.")
    
    parser.add_argument("--actions_dir", type=str, default='../../computer/train_dataset_encoded4/raw_data_apr2/actions',
...
if __name__ == "__main__":
    ...
    try:
        ...
        with open(os.path.join(save_dir, 'filtered_image_action_mapping_with_key_states.pkl'), 'wb') as f:
