...
def parse_args():
    ...
    parser.add_argument("--input_dir", type=str, 
                        default="../data/data_processing/train_dataset_may20_9_webdataset",
                        help="Path to input dataset directory with WebDataset tar files.")
    parser.add_argument("--video_dir", type=str, default="/home/yuntian/scratch/raw_data_may20_9/raw_data/videos",
                        help="Path to raw video files. If provided, will process videos directly instead of tar files.")
    
    parser.add_argument("--output_dir", type=str, 
                        default="./train_dataset_may20_9_webdataset_encoded",
